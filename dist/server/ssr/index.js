...
var client_references_default = {
	"08b09c7e3c15": async () => {
		const m = await import("./assets/service-information-content-CLUKYvL4.js");
		return { get "ServiceInformationContent"() {
			return m["ServiceInformationContent"];
		} };
	},
	"0d7c68e5e60d": async () => {
		const m = await import("./assets/page-B7TXBMiP.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-CAgCBiCV.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"58364f07e0d2": async () => {
		const m = await import("./assets/page-CWpoP0X7.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-UfZcD8fq.js");
		return {
			get "ErrorBoundary"() {
	...
	"64042da5faab": async () => {
		const m = await import("./assets/page-C2P7s5HN.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"64624beb05ee": async () => {
		const m = await import("./assets/page-HH9i--59.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"6efdf509a785": async () => {
		const m = await import("./assets/page-CLNB6YMj.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"724dcbd470a5": async () => {
		const m = await import("./assets/page-OCQSspeB.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"7574b92b0308": async () => {
		const m = await import("./assets/localized-policies-BWZcb3tB.js");
		return {
			get "CareGuaranteeLocalized"() {
				return m["CareGuaranteeLocalized"];
			},
			get "PrivacyLocalized"() {
				return m["PrivacyLocalized"];
			},
			get "ServiceInformationLocalized"() {
				return m["ServiceInformationLocalized"];
			},
			get "TermsLocalized"() {
				return m["TermsLocalized"];
			}
		};
	},
	"8c0f216c4604": async () => {
	...
	"a7c2b21269ea": async () => {
		const m = await import("./assets/page-BOGLCD7B.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"ad47e410af6a": async () => {
		const m = await import("./assets/page-BuQD99hF.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"b49ea5cf04c0": async () => {
		const m = await import("./assets/page-BF3-8MZu.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"c2747888630f": async () => {
		const m = await import("./assets/link-BeSeDncp.js").then((n) => n.n);
		return { get "default"() {
			return m["default"];
		} };
	},
	"c8d62b462541": async () => {
		const m = await import("./assets/page-B5sszxAO.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"d3e49f7d02a9": async () => {
		const m = await import("./assets/auth-provider-DRNPY7tG.js");
		return { get "AuthProvider"() {
			return m["AuthProvider"];
		} };
	},
	"e41c859232b2": async () => {
		const m = await import("./assets/page-Dbr9_coe.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"ec4acbc49ec5": async () => {
		const m = await import("./assets/page-DQcrai6I.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"ffcf25d32a46": async () => {
		const m = await import("./assets/legal-shell-CO9FWWKW.js");
		return { get "LegalShell"() {
			return m["LegalShell"];
		} };
	}
};
